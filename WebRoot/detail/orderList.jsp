...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="${pageContext.request.contextPath}/detail/style/css/index_1.css" />
		<script type="text/javascript">
	...
	<body>
			...
			<div id="TitleArea_Title">
				<div id="TitleArea_Title_Content">
					<img border="0" width="13" height="13"
						src="${pageContext.request.contextPath}/detail/style/images/title_arrow.gif" />
					餐厅订单列表
				</div>
			</div>
		...
		<div id="MainArea">
			<table class="MainArea_Content" align="center" cellspacing="0"
				...
				<!--显示数据列表 -->
				<tbody id="TableData">
					<c:forEach var="temp" items="${requestScope.orderList.data}">
						<tr height="60">
							<td>
								${pageScope.temp.ORDERID}
							</td>
							<td>
								纽约
							</td>
